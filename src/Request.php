...
class Request {
    ...
    public static function ipAddress(): string {
        ...
        if ($trusted === '*' || in_array($remote, $trustedList, true)) {
    ...
    /** HEAD判定 */
    public static function isHead(): bool { return self::isMethod('HEAD'); }
    /** メソッド判定 */
    public static function isMethod($method): bool { return self::method() === strtoupper($method); }
