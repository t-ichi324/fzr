...
class Response {
    ...
    /** ヘッダ取得 */
    public static function getHeader(string $name): ?string { return self::$headers[$name] ?? null; }
    ...
    // Hook
    // =============================
    public static function beforeSend(?callable $callback) { self::$before = $callback; }
    public static function afterSend(?callable $callback) { self::$after = $callback; }
    ...
    /** ステータスコード取得 */
    public static function getStatusCode(): int { return self::$statusCode; }
